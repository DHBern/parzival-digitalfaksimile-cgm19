function checkVers(vWerk) {
	if (vWerk == "") {
		if (werk == "Parzival" || werk == "Titurel") {
			vWerk = "v" + werk;
		/*} else if (werk == "Parzival / Titurel") {
			vWerk = "vParzival";*/
		} else {
			alert ("Bitte entscheiden Sie, ob sich die Versangabe auf den »Parzival« oder den »Titurel« bezieht.");
		}
	}
...
if (vers >=88.13 && vers <=94.30) {curSlide=9; rectoVerso="r"; seiteKorrektur();}
if (vers >=95.01 && vers <=101.17) {curSlide=9; rectoVerso="v"; seiteKorrektur();}
...
if (vers >=127.08 && vers <=133.30) {curSlide=12; rectoVerso="r"; seiteKorrektur();}
if (vers >=134.01 && vers <=141.09) {curSlide=12; rectoVerso="v"; seiteKorrektur();}
...
if (vers >=331.15 && vers <=340.29) {curSlide=26; rectoVerso="r"; seiteKorrektur();}
if (vers >=340.30 && vers <=348.15) {curSlide=26; rectoVerso="v"; seiteKorrektur();}
...
if (vers >=533.17 && vers <=538.30) {curSlide=42; rectoVerso="r"; seiteKorrektur();}
if (vers >=539.01 && vers <=544.16) {curSlide=42; rectoVerso="v"; seiteKorrektur();}
...
if (vers >=572.03 && vers <=578.02) {curSlide=45; rectoVerso="v"; seiteKorrektur();}
if (vers >=578.03 && vers <=583.28) {curSlide=46; rectoVerso="r"; seiteKorrektur();}
...
if (vers > 175.04) {alert("Der letzte Vers des »Titurel« ist 175.04"); document.form1.Vers.value=""; return;}
...
if (vers >=62.00 && vers <=90.03) {curSlide=72; rectoVerso="r"; seiteKorrektur();}
if (vers >=90.04 && vers <=113.02) {curSlide=72; rectoVerso="v"; seiteKorrektur();}
