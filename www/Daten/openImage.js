...
function loadImage() {
    ...
    } if (imgMode === "bildLink" || imgMode === "bildLinkGast" ) {
...
function getImgSrc() {
	if (imgMode === "register") {
    	return '../GBilder/G150/' + bild + '.jpg';
    }
	if (imgMode === "bildLink" || imgMode === "bildLinkGast" || "bildLinkFull") {
        return '../GBilder/Ambrosiana/' + bild + '.jpg';
    }
}
